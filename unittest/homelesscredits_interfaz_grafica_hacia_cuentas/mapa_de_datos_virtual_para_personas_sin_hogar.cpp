...
void mapa_de_datos_virtual_para_personas_sin_hogar::initialize_hash_function()
{
...
int mapa_de_datos_virtual_para_personas_sin_hogar::get_character_index(QString character_to_rotate)
{
    int output = -1;
...
int mapa_de_datos_virtual_para_personas_sin_hogar::rotate_character(QString character_to_rotate, qint32 iterations)
{
    int output = -1;
...
QString mapa_de_datos_virtual_para_personas_sin_hogar::reduce_string(QString additive_string, int target_size, qint32 iterations)
{
...
void mapa_de_datos_virtual_para_personas_sin_hogar::unit_test_rotate_character()
{
    /*
